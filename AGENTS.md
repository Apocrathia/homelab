...
- Keep the context window thin; compact early, hand off as files
  ([`context-management.md`](./.agents/rules/context-management.md),
  [`context/context-management.md`](./.agents/context/context-management.md))
...
| Sync shared .agents/ from the shared core  | [`integrate-upstream`](./.agents/skills/integrate-upstream/SKILL.md)                                                                                                                       |
...
| Deep read-only diff review                 | [`review-correctness`](./.agents/skills/review-correctness/SKILL.md), [`review-security`](./.agents/skills/review-security/SKILL.md), [`review-fit`](./.agents/skills/review-fit/SKILL.md) |
| Draft commit/MR handoff                    | [`draft-commit`](./.agents/skills/draft-commit/SKILL.md)                                                                                                                                   |
| Authorized ship (MR contribute)            | [`ship-work`](./.agents/skills/ship-work/SKILL.md)                                                                                                                                         |
| Constant / unattended loop                 | [`run-loop`](./.agents/skills/run-loop/SKILL.md), [`development-loop.md`](./.agents/context/development-loop.md)                                                                           |
| Full contribute work graph                 | [`self-improve`](./.agents/skills/self-improve/SKILL.md), [`development-loop.md`](./.agents/context/development-loop.md)                                                                   |
| Babysit open MR                            | [`watch-mr`](./.agents/skills/watch-mr/SKILL.md)                                                                                                                                           |
| Post-merge worktree teardown               | [`clock-out`](./.agents/skills/clock-out/SKILL.md)                                                                                                                                         |
...
| Acceptance review against a Bar            | [`reviewer`](./.agents/agents/reviewer/agent.md)                                                                                                                                           |
| Validating manifest diffs                  | [`manifest-verifier`](./.agents/agents/manifest-verifier/agent.md)                                                                                                                         |
| Creating a new agent persona               | [`create-agent`](./.agents/skills/create-agent/SKILL.md)                                                                                                                                   |
| Creating a new skill                       | [`create-skill`](./.agents/skills/create-skill/SKILL.md)                                                                                                                                   |
...
| Plain-language / ADHD-shaped output        | [`eli5`](./.agents/skills/eli5/SKILL.md), [`i-have-adhd`](./.agents/skills/i-have-adhd/SKILL.md)                                                                                           |
