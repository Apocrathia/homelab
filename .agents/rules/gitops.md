...
- Direct applies are observation only. Flux reasserts Git on reconcile — commit and push before expecting persistence. Suspending a child Kustomization alone may not hold if a parent manages it.
