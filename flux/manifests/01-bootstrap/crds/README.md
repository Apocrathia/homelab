...
- **Gateway API (standard channel)** — routing CRDs: `Gateway`, `HTTPRoute`,
  `TLSRoute`, and related types. Keep this at or above the version Cilium's
  Gateway API controller requires; see `kustomization.yaml`.
