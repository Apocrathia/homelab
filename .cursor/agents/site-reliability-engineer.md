...
- `.cursor/skills/` — procedural runbooks (CNPG restore, Longhorn restore, helm deployment)
...
- **CNPG restore**: `.cursor/skills/cnpg-logical-database-restore/SKILL.md`
- **Longhorn restore**: `.cursor/skills/generic-app-longhorn-restore/SKILL.md`
- **Helm deployment issues**: `.cursor/skills/helm-deployment/SKILL.md`
