...
| Prompt                                                     | Role                                                                                                                                                              |
| ---------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`.cursor/skills/generic-app-longhorn-restore/SKILL.md`** | PV/PVC **Retain**, **`fromBackup`**, **`helm template`** for **`storage.longhorn.volumes`** — **not** CNPG instance templates; reuse ideas for **RWO** CNPG PVCs. |
...
2. For a **full** Longhorn restore of the CNPG volume (same **Retain / delete / restore / rebind** ideas as **`.cursor/skills/generic-app-longhorn-restore/SKILL.md`**, but for the **dynamically provisioned** instance PVC, not `storage.longhorn.volumes`):
...
- `.cursor/skills/generic-app-longhorn-restore/SKILL.md` — Longhorn **Retain**, **`fromBackup`**, static PV/PVC patterns (adapt for CNPG instance PVC naming).
