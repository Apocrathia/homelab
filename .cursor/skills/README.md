...
| `integrate-upstream`            | [`.agents/skills/integrate-upstream`](../../.agents/skills/integrate-upstream/SKILL.md)                       | Pull shared .agents/ updates from the shared core |
...
| `review-correctness`            | [`.agents/skills/review-correctness`](../../.agents/skills/review-correctness/SKILL.md)                       | Read-only correctness lens for a diff             |
| `review-security`               | [`.agents/skills/review-security`](../../.agents/skills/review-security/SKILL.md)                             | Read-only security lens for a diff                |
| `review-fit`                    | [`.agents/skills/review-fit`](../../.agents/skills/review-fit/SKILL.md)                                       | Read-only design-fit lens for a diff              |
| `eli5`                          | [`.agents/skills/eli5`](../../.agents/skills/eli5/SKILL.md)                                                   | Plain-language explanation style                  |
| `i-have-adhd`                   | [`.agents/skills/i-have-adhd`](../../.agents/skills/i-have-adhd/SKILL.md)                                     | ADHD-shaped output style                          |
